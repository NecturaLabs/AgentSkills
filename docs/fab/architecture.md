...
Source paths here are relative to the crate, [`cli/fab/`](../../cli/fab).
...
Claude Code / Codex / other agents
        │  loads skills/fab/SKILL.md (installed as a plugin), runs the CLI
        ▼
...
- **Another provider:** see `docs/fab/providers.md`.
...
- `docs/fab/adr/0001-implementation-language.md`
- `docs/fab/adr/0002-marketplace-access-through-fabcli.md`
- `docs/fab/adr/0003-gating-account-and-monetary-actions.md`
