...
always pass `--json`. Command and flag reference: `skills/fab/references/commands.md`.
...
Branch on the exit code first, then `error.code`: `skills/fab/references/errors.md`.
