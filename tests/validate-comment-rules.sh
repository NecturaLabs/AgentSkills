...
# review-checklist.md is the FIRST of the four paths handed to a dispatched reviewer, so a
# severity stated only in the other three is a severity the reviewer never reads. It carries the
